...
class SerialPortReader:
    def __init__(self, master):
        ...
        self.input_text_to_esp32_ent.bind("<Return>",self.read_data_form_esp32_via_serial_port_func)   # Enter
    ...
    def read_data_form_esp32_via_serial_port_func(self, event):
        ...
        # data = readDataEsp32.read()               # ! อ่านเข้ามาได้แค่อักษรตัวเดียว
        # data = readDataEsp32.read_all()           # ? อ่านเข้ามาทั้งหมดหลายๆบรรทัด
        # data = readDataEsp32.read_until("\r\n")   # ? อ่านเข้ามาทั้งหมดหลายๆบรรทัด
        # data = readDataEsp32.readable()           # ! แสดงค่า True Or False
        # data = readDataEsp32.readline()           # ? อ่านเข้ามาได้แค่ บรรทัดเดียว
        data = readDataEsp32.readlines()            # ? อ่านเข้ามาทั้งหมดหลายๆบรรทัด
        print(data)
